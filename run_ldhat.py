...
dir = '/mnt/lustre/home/sonal.singhal1/LTF/phasing/LDhat/'
num_jobs = 10
...
for ix in range(num_jobs):
	...
	for loc_file in files[ix * num_cmds: ix*num_cmds + num_cmds]:
		...
		call = '/mnt/lustre/home/sonal.singhal1/bin/LDhat_v2.2/interval -seq %s -loc %s -lk /mnt/lustre/home/sonal.singhal1/LTF/phasing/LDhat/LTFnew_lk.txt -its 5000000 -samp 5000 -bpen 5.0 -prefix %s' % (site_file, loc_file, prefix)
		o.write(call + '\n')
	o.close()
