	...
	for line in r:
		if re.search('^#', line):
			...
			if d[0] != cur_chr:
				if out_file:
					o.close()
				out_file = '%sgatk.ug.zf.%s.filtered.coverage.vqsr.vcf.gz' % (out_dir, d[0])
...
def main():     
	...
	vcf_file = '/mnt/lustre/home/sonal.singhal1/LTF/after_vqsr/gatk.ug.ltf.allchrs.allvar.filtered.vqsr.vcf.gz'
        ...
        # out directory      
	out_dir = '/mnt/lustre/home/sonal.singhal1/LTF/after_vqsr/by_chr/'
