...
files = glob.glob('/mnt/gluster/home/sonal.singhal1/ZF/analysis/hotspots/hotspot_checks/phasing_uncertainty/*sum')
...
for file in files:
	...
	sp = re.search('([A-Z]+)\.seqLDhot', file).group(1)
	...
	print '%s,%s,%s,%s,%s,%s,%s,%s' % (chr, bp, rep, sp, match_lk, match_heat, match_start, match_length)
