...
chrs = ['chr1', 'chr1A', 'chr2', 'chr3', 'chr4', 'chr4A', 'chr5', 'chr6', 'chr7', 'chr8', 'chr9', \
		'chr10', 'chr11', 'chr12', 'chr13', 'chr14', 'chr15', 'chr27']
...
block = 50e3
nhap = 38
results_dir = '/mnt/gluster/home/sonal.singhal1/ZF/analysis/phase_hotspots/'
theta = 0.00654
...
for chr, start, length, back_rho in zip(d.chr, d.spot_start, d.length, d.flank_rate):
